...
public class EmailService {
    ...
    private void sendSSLMessage(String recipients[], String subject,
        ...
        boolean validationEmails = true;
        if (!isValidEmailAddress(from)) validationEmails = false;


        for (String sendAdress : sendTo) {
            if (!isValidEmailAddress(sendAdress)) validationEmails = false;
        }
        if (validationEmails) {
            boolean debug = true;
